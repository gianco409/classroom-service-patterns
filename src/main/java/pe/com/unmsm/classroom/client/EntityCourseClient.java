...
@Slf4j
public class EntityCourseClient {
	...
	public List<Course> getAll() {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Courses";
			...
			response = gsonReq.fromJson(responseClient.getEntity(String.class), Course[].class);
	...
	public Course getCourse(Integer id) {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Courses/" + id;
			Client client = Client.create();
			WebResource wrs = client.resource(url);
