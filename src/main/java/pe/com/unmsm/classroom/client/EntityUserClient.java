...
public class EntityUserClient {
	...
	public List<User> getAll() {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Users";
			...
			response = gsonReq.fromJson(responseClient.getEntity(String.class), User[].class);
	...
	public User getUser(Integer id) {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Users/" + id;
			Client client = Client.create();
			WebResource wrs = client.resource(url);
