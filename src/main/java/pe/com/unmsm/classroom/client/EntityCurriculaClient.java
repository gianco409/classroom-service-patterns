...
@Slf4j
public class EntityCurriculaClient {
	...
	public List<Curricula> getAll() {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Curricula";
			...
			response = gsonReq.fromJson(responseClient.getEntity(String.class), Curricula[].class);
	...
	public Curricula getCurricula(Integer id) {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Curricula/" + id;
			Client client = Client.create();
			WebResource wrs = client.resource(url);
