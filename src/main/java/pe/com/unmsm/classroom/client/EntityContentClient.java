...
@Slf4j
public class EntityContentClient {
	...
	public List<Content> getAll() {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Contents";
			...
			response = gsonReq.fromJson(responseClient.getEntity(String.class), Content[].class);
	...
	public Content getContent(Integer id) {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "Contents/" + id;
			Client client = Client.create();
			WebResource wrs = client.resource(url);
