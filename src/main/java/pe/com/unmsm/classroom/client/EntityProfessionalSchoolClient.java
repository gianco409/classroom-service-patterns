...
@Slf4j
public class EntityProfessionalSchoolClient {
	...
	public List<ProfessionalSchool> getAll() {
		...
		ProfessionalSchool[] response = null;
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "ProfessionalSchools";
			...
			response = gsonReq.fromJson(responseClient.getEntity(String.class), ProfessionalSchool[].class);
	...
	public ProfessionalSchool getProfessionalSchool(Integer id) {
		...
		try {
			...
			String url = Constantes.wsEntitiesMaintenanceServices + "ProfessionalSchools/" + id;
			Client client = Client.create();
			WebResource wrs = client.resource(url);
